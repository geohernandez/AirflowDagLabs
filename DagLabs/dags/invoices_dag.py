...
def transform_data(*args, **kwargs):
    logging.warning("Hey rock the data_path is %s and transformed_path is %s", data_path, transformed_path)
    logging.warning(f'The value of datapath Get Extra is: {BaseHook.get_connection("data_path").get_extra()}')
...
with DAG(dag_id="invoices_dag",
    ...
    is_new_data_available = FileSensor(
        task_id="is_new_data_available_FullyTested",
